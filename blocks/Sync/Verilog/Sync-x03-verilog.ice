{
  "version": "1.2",
  "package": {
    "name": "Sync-x03-verilog",
    "version": "0.1",
    "description": "Sync a 3-bit input with the system clock domain (Verilog implementation)",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "c83fbc51-0627-4723-8265-aede0c872ce1",
          "type": "basic.output",
          "data": {
            "name": "",
            "range": "[2:0]",
        ...
        {
          "id": "c7010ac5-55f0-4f1e-bc5e-9c0d87e3500c",
          "type": "basic.input",
          "data": {
            "name": "",
            "range": "[2:0]",
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "c7010ac5-55f0-4f1e-bc5e-9c0d87e3500c",
            "port": "out"
          },
          "target": {
            "block": "241d8ad5-cbb6-46e0-ad22-0e1028aea9b1",
        ...
        },
        {
          ...
          "target": {
            "block": "c83fbc51-0627-4723-8265-aede0c872ce1",
            "port": "in"
          },
          "size": 3
        }
